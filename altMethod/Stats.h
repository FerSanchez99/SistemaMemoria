...
{
    private:
        double dTime; // Var llevara conteo del tiempo de la simulacion
        vector< pair<int,double> > vTA;  // vector de pares que guarda el turnaoround de cada proceso, el pair.first esta el id proceso y en pair.second esta el turnarounf
